<footer class="page-footer">
    <div class="container footer-info">
        <div class="row">
            <div class="col s12 l4 ">
                ...
                <ul>
                    <li><a class="grey-text text-lighten-3 animated slideInUp wow" href="https://github.com/ankit-16"><i class="tiny material-icons" style="position:relative;top:3px">developer_mode</i> Ankit Gupta</a></li>
                </ul>
            </div>
            <div class="col s12 l4 ">
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            <a class="grey-text text-lighten-4 right animated slideInUp wow" href=""><i class="fa fa-heartbeat animated pulse infinite red-text"></i>Ankit Gupta</a>
        </div>
    </div>
</footer>
